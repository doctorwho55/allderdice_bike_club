...
class NewsPostsControllerTest < ActionController::TestCase
  ...
  test "should create news_post" do
    assert_difference('NewsPost.count') do
      post :create, news_post: { author: @news_post.author, body: @news_post.body, title: @news_post.title, user_id: @news_post.user_id }
    end
  ...
  test "should update news_post" do
    patch :update, id: @news_post, news_post: { author: @news_post.author, body: @news_post.body, title: @news_post.title, user_id: @news_post.user_id }
    assert_redirected_to news_post_path(assigns(:news_post))
  end
