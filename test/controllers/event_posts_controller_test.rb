...
class EventPostsControllerTest < ActionController::TestCase
  ...
  test "should create event_post" do
    assert_difference('EventPost.count') do
      post :create, event_post: { author: @event_post.author, event_date_time: @event_post.event_date_time, event_description: @event_post.event_description, event_name: @event_post.event_name, title: @event_post.title, user_id: @event_post.user_id }
    end
  ...
  test "should update event_post" do
    patch :update, id: @event_post, event_post: { author: @event_post.author, event_date_time: @event_post.event_date_time, event_description: @event_post.event_description, event_name: @event_post.event_name, title: @event_post.title, user_id: @event_post.user_id }
    assert_redirected_to event_post_path(assigns(:event_post))
  end
